...
L_SRC_FOUNDATION := $(_SRC_FDN)/ALooper.cpp $(_SRC_FDN)/AString.cpp $(_SRC_FDN)/ALooperRoster.cpp $(_SRC_FDN)/AMessage.cpp $(_SRC_FDN)/ABuffer.cpp $(_SRC_FDN)/AAtomizer.cpp $(_SRC_FDN)/hexdump.cpp
